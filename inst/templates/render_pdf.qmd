...
Deze bijlage bevat de fairness-metrieken en model-voorspellingsplots voor elke onderzochte variabele. Voor uitleg van de fairness-metrieken, zie [Stap 3: Fairness evaluatie](#stap-3-fairness-evaluatie-controleren-op-eerlijkheid) in de Methodologie sectie.
...
-   **Gekleurde zones**: Rood = Bias, Wit = acceptabel bereik

-   Hoe verder de staaf van 0.0 afligt, hoe groter het verschil met de referentiegroep

Zie ook de uitleg van de referentiegroep in [Stap 3: Fairness evaluatie](#stap-3-fairness-evaluatie-controleren-op-eerlijkheid).
