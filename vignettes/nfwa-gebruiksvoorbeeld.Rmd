...
# Laad je 1CHO data
data_ev <- rio::import("data/input/EV_data.parquet")
data_vakhavw <- rio::import("data/input/VAKHAVW_data.parquet")
...
```{r transform}
# Laad je ruwe 1CHO data (Parquet of CSV)
data_ev <- rio::import("data/input/EV_data.parquet")        # Inschrijvingsdata
data_vakhavw <- rio::import("data/input/VAKHAVW_data.parquet")  # Vak/cijferdata
...
df <- transform_data(
  ...
  eoi = 2020,  # Eerste Opleiding Inschrijvingsjaar aan deze opleiding/instelling
  data_ev = data_ev,
  data_vakhavw = data_vakhavw
)
